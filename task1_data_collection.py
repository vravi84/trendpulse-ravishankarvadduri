...
categories={
    ...
    "science": ["research", "study", "space", "physics", "biology","science", "scientist", "experiment", "lab","quantum", "energy", "climate", "earth","medicine", "health", "dna", "brain", "universe"],
    ...
    #  print(data)
     ...
     for category, keywords in categories.items():
      if any(keyword in title for keyword in keywords):
        if(len(stories_with_catagories[category])<50):
            print("===========",category,len(stories_with_catagories[category]),"=============")
            required_story={
           "post_id":data.get('id'),
...
for c,k in stories_with_catagories.items():
   print(c,len(k))       
